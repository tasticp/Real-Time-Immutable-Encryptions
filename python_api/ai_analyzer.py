...
class AIAnalyzer:
    ...
    async def analyze_frame(self, frame: np.ndarray, metadata: VideoMetadata) -> VideoMetadata:
    ...
    def estimate_camera_specs(self, frame: np.ndarray, metadata: VideoMetadata) -> Dict[str, Any]:
...
class EvidenceProcessor:
    ...
    async def process_video_evidence(self, video_path: str, device_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            while True:
                ...
                if frame_count % sample_rate == 0:
                    ...
                    enhanced_metadata = await self.ai_analyzer.analyze_frame(frame, metadata)
                    ...
                    if enhanced_metadata.faces_detected:
                        all_faces["total_faces"] = all_faces.get("total_faces", 0) + len(enhanced_metadata.faces_detected)
